 ...
 * Redefinition of pointers to hardware registers and some CMSIS functions,
 * make them point to simulated instances instead of the actual hardware
 * addresses.
 * @version 0.1
 * @date 2026-03-09
...
#define __NVIC_EnableIRQ(irq_no)
#define __NVIC_DisableIRQ(irq_no)
