...
CAN_TypeDef *can1 = &can1_instance;
...
void (*CAN1_TX_IRQHandler_ptr)() = nullptr;
void (*CAN1_RX0_IRQHandler_ptr)() = nullptr;
void (*CAN1_RX1_IRQHandler_ptr)() = nullptr;
void (*CAN1_SCE_IRQHandler_ptr)() = nullptr;
...
reset()
{
  ...
  memset(&can1_instance, 0, sizeof(can1_instance));
  ...
  CAN1_TX_IRQHandler_ptr = nullptr;
  CAN1_RX0_IRQHandler_ptr = nullptr;
  CAN1_RX1_IRQHandler_ptr = nullptr;
  CAN1_SCE_IRQHandler_ptr = nullptr;
