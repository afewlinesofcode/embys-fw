...
String
stringifyBinaryExpr(const DOCTEST_REF_WRAP(L) lhs, const char *op,
...
DOCTEST_INTERFACE bool
decomp_assert(assertType::Enum at, const char *file, int line, const char *expr,
              const Result &result);
...
template <typename L>
DOCTEST_NOINLINE bool
unary_assert(assertType::Enum at, const char *file, int line, const char *expr,
...
// do when empty)
bool
matchesAny(const char *name, const std::vector<String> &filters,
...
bool
parseOptionImpl(int argc, const char *const *argv, const char *pattern,
                String *value)
{
...
bool
parseOption(int argc, const char *const *argv, const char *pattern,
...
// arguments in argv
bool
parseCommaSepArgs(int argc, const char *const *argv, const char *pattern,
...
bool
parseIntOption(int argc, const char *const *argv, const char *pattern,
...
{
void
registerReporterImpl(const char *name, int priority, reporterCreatorFunc c,
                     bool isReporter)
{
    if (isReporter)
        getReporters().insert(
