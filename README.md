...
This is simply a logical simulator, so no real hardware emulation like QEMU should be expected, but it is very lightweight and allows easy testing of application logic. Not sure about code based on HAL—it may use more structures than I've mocked, and it definitely hides some details without any opportunity to extend them to add testing hooks. I'll need to check if HAL can allow injection of custom mocks for peripherals.
